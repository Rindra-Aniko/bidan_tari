<footer class="bg-pink-600 text-white pt-16 pb-8 px-6 md:px-16 lg:px-24">
  ...
  <div class="max-w-6xl mx-auto">
      ...
      <div class="lg:col-span-1 space-y-4">
        ...
        <div class="flex items-center gap-3 pt-2">
          <a href="https://www.facebook.com/sridebby.utari.3" target="_blank" rel="noopener noreferrer" class="w-9 h-9 bg-white rounded-lg flex items-center justify-center hover:bg-pink-50 transition-colors group" aria-label="Facebook">
            <svg class="w-4 h-4 text-pink-600 transition-colors" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="https://www.instagram.com/pbm_tari_lorenda/" target="_blank" rel="noopener noreferrer" class="w-9 h-9 bg-white rounded-lg flex items-center justify-center hover:bg-pink-50 transition-colors group" aria-label="Instagram">
            <svg class="w-4 h-4 text-pink-500 transition-colors" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div class="space-y-4">
        ...
        <div class="space-y-3">
          ...
          <div class="flex items-center gap-3">
            <svg class="w-4 h-4 text-pink-100 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
            </svg>
            <a href="tel:+6285266761076" class="text-sm text-pink-100 hover:text-white transition-colors font-montserrat font-medium">
              +62 852 6676 1076
            </a>
          </div>
        </div>
    ...
    <!-- Divider + Copyright -->
    <div class="border-t border-pink-400 pt-8 flex flex-col md:flex-row items-center justify-between gap-3">
      <p class="text-xs text-white/80 font-montserrat">
        &copy; 2024 Bdn. Sri Debi Utari. All rights reserved.
      </p>
      <p class="text-xs text-white/80 font-montserrat">
        Developed by <a href="https://ryndigitalpro.com" target="_blank" rel="noopener noreferrer" class="text-pink-100 hover:text-white transition-colors">RYN Digital Pro</a>
      </p>
    </div>
  </div>
</footer>
