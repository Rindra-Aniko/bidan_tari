...
<svelte:head>
  <title>Articles & Educational Guides — Midwife Sri Deby Utari Clinic</title>
  <meta name="description" content="Trusted health guides for mothers and babies. Discover professional pregnancy advice, newborn care tips, and maternal health news from Midwife Sri Deby Utari Clinic." />
    ...
    <div class="lg:col-span-7 space-y-8">
      <div class="space-y-5">
        ...
        <h1 class="text-4xl md:text-7xl font-black leading-[1.1] font-merriweather text-gray-900">
          Maternal & <span class="text-pink-500">Child Health</span> <br/> Journal
        </h1>
      </div>

      <p class="text-gray-600 text-lg md:text-xl max-w-xl leading-relaxed font-montserrat">
        Your trusted resource for mother and child wellness. Explore professional guides, pregnancy advice, and expert midwife recommendations.
      </p>

      <div class="flex items-center gap-4 pt-4">
        <div class="flex -space-x-3 overflow-hidden">
          <img class="inline-block h-11 w-11 rounded-full ring-[3px] ring-white object-cover" src={optimizeImageUrl("/image/nialana_afrilia.webp", 88)} alt="Mother Avatar" width="44" height="44" loading="lazy">
          <img class="inline-block h-11 w-11 rounded-full ring-[3px] ring-white object-cover" src={optimizeImageUrl("/image/deka_apriani.webp", 88)} alt="Midwife Avatar" width="44" height="44" loading="lazy">
        ...
        <p class="text-sm text-gray-400 font-montserrat">
          Join thousands of empowered mothers
        </p>
      </div>
    </div>
      ...
      <div class="bg-white p-5 rounded-3xl border border-pink-100 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-500 max-w-md w-full">
        <div class="overflow-hidden rounded-2xl">
          <img
            ...
            alt="Nursery interior illustration"
...
<section class="w-full bg-white py-5 sticky top-20 z-40 border-b border-gray-100">
  <div class="max-w-7xl mx-auto flex items-center gap-3 overflow-x-auto no-scrollbar px-6 justify-start md:justify-center">
    ...
    {#each ['Pregnancy', 'Labor & Birth', 'Baby Care', 'Maternal Health', 'Nutrition'] as cat}
      <a
        href="?category={cat}"
        class="whitespace-nowrap rounded-full px-8 py-3 text-sm font-bold transition-all font-montserrat
    ...
    <div data-reveal="hidden" style="--rev-y: 40px; --rev-dur: 800ms; --rev-del: 100ms;" class="grid grid-cols-1 lg:grid-cols-3 gap-8" use:reveal={{ y: 40, duration: 800, delay: 100 }}>
      ...
      {#if !featuredArticle && articles.length === 0}
        <div class="col-span-full py-24 text-center bg-white rounded-3xl border border-pink-100/60 p-8 shadow-sm">
          ...
          <h3 class="text-xl font-bold font-merriweather text-gray-800">No Articles Available Yet</h3>
          <p class="text-gray-500 text-sm mt-2 max-w-md mx-auto">We are currently crafting expert health guides and maternal advice for you. Please check back soon!</p>
        </div>
      {:else}
        <!-- Featured Article -->
        {#if featuredArticle}
            ...
            <div>
              ...
              <div class="flex items-center gap-4 text-xs font-bold mb-5 uppercase tracking-widest">
                ...
                <span class="text-gray-400 flex items-center gap-2">
                  ...
                  {new Date(featuredArticle.createdAt).toLocaleDateString('en-US', { day: 'numeric', month: 'short', year: 'numeric' })}
                </span>
                {#if featuredArticle.authorName}
                  <span class="text-gray-400">By: {featuredArticle.authorName}</span>
                {/if}
              </div>
          ...
          <div class="bg-white rounded-2xl overflow-hidden p-6 border border-pink-100 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 flex flex-col justify-between h-full">
            <div>
              ...
              <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-[10px] text-gray-400">{new Date(article.createdAt).toLocaleDateString('en-US', { day: 'numeric', month: 'short' })}</span>
              </div>
    ...
    <div class="bg-white shadow-xl shadow-pink-500/5 rounded-3xl p-10 md:p-16 flex flex-col md:flex-row items-center gap-14 justify-between border border-gray-100">
      ...
      <div class="w-full md:w-1/2 flex flex-col justify-center">
        ...
        <h2 class="text-gray-900 text-3xl md:text-4xl font-black leading-tight mb-5 font-merriweather">
          Track Your Baby's <span class="text-pink-500">Growth Journey</span>
        </h2>
        <p class="text-gray-600 text-base md:text-lg leading-relaxed mb-8 font-montserrat">
          Receive personalized guides tailored to your pregnancy week or your baby's development stage every week.
        </p>
      ...
      <div class="w-full md:w-[420px] bg-pink-50 rounded-2xl p-8 md:p-10 border border-pink-100 relative overflow-hidden">
        ...
        <div class="relative pl-10 space-y-8">
          ...
          <div class="relative group">
            ...
            <div>
              <h4 class="font-black text-gray-900 text-sm font-merriweather">Months 1–3</h4>
              <p class="text-sm text-gray-400 mt-1 font-montserrat">Formation of Primary Vital Organs</p>
            </div>
          </div>
          ...
          <div class="relative group">
            ...
            <div>
              <h4 class="font-black text-gray-900 text-sm font-merriweather">Months 4–6</h4>
              <p class="text-sm text-gray-400 mt-1 font-montserrat">Feeling Baby's First Gentle Movements</p>
            </div>
          </div>
          ...
          <div class="relative group">
            ...
            <div>
              <h4 class="font-black text-gray-900 text-sm font-merriweather">Months 7–9</h4>
              <p class="text-sm text-gray-400 mt-1 font-montserrat">Final Preparation for Safe Childbirth</p>
            </div>
          </div>
        </div>
      </div>
