    ...
    <div class="lg:col-span-7 space-y-8">
      ...
      <div class="flex items-center gap-4 pt-4">
        <div class="flex -space-x-3 overflow-hidden">
          <img class="inline-block h-11 w-11 rounded-full ring-[3px] ring-white object-cover" src={optimizeImageUrl("https://images.unsplash.com/photo-1531123897727-8f129e1bf98c", 88)} alt="Avatar ibu" width="44" height="44" loading="lazy">
