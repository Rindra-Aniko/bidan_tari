    ...
    <div class="lg:col-span-7 space-y-8">
      ...
      <div class="flex items-center gap-4 pt-4">
        <div class="flex -space-x-3 overflow-hidden">
          <img class="inline-block h-11 w-11 rounded-full ring-[3px] ring-white object-cover" src={optimizeImageUrl("/image/nialana_afrilia.webp", 88)} alt="Avatar ibu" width="44" height="44" loading="lazy">
          <img class="inline-block h-11 w-11 rounded-full ring-[3px] ring-white object-cover" src={optimizeImageUrl("/image/deka_apriani.webp", 88)} alt="Avatar bidan" width="44" height="44" loading="lazy">
