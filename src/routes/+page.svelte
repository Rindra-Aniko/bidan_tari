...
<svelte:head>
  <title>Midwife Sri Deby Utari Clinic — 24/7 Maternity & Child Healthcare</title>
  <meta name="description" content="Midwife Sri Deby Utari Clinic offers 24/7 natural childbirth, baby spa, prenatal yoga, and pregnancy checkups. Accepting BPJS & Private Patients in Kerinci, Jambi." />
  ...
  <div class="container mx-auto px-6 md:px-12 lg:px-24 relative z-10">
    <div class="max-w-2xl">
      ...
      <p class="text-gray-700 font-medium text-lg md:text-xl leading-relaxed mb-4 max-w-xl font-montserrat">
        Over 12 years of dedicated expertise in caring for mothers and newborns. Because your well-being and your baby's healthy smile are our absolute top priority.
      </p>
...
<section class="max-w-6xl w-full mx-auto py-20 md:py-28 px-6">
  ...
  <div class="text-center mb-16">
    <span class="text-pink-500 text-xs font-bold tracking-widest uppercase font-montserrat">Services</span>
  ...
  <div class="max-w-6xl mx-auto">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      ...
      <div class="space-y-8" use:reveal={{ y: 50, delay: 200, duration: 800 }}>
        <div class="space-y-4">
          <span class="text-pink-500 text-xs font-bold tracking-widest uppercase font-montserrat">Why Choose Us</span>
          ...
          <p class="text-gray-500 font-montserrat text-base leading-relaxed">
            We understand that every pregnancy and birth is an extraordinary physical and emotional journey. For over a decade, we have dedicated ourselves to providing compassionate, gold-standard healthcare for your family's peace of mind.
          </p>
        </div>
...
<section class="py-20 md:py-28 px-6">
  <div class="max-w-6xl mx-auto w-full">
    ...
    <div class="text-center mb-16" use:reveal={{ y: 30 }}>
      <span class="text-pink-500 text-xs font-bold tracking-widest uppercase font-montserrat">Testimonials</span>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6" use:reveal={{ y: 50, duration: 800 }}>
        ...
        <div>
          ...
          <div class="border-l-2 border-pink-200 pl-4 mb-8">
            <p class="text-gray-600 font-montserrat leading-relaxed text-sm">
              "Midwife Deby's warmth and patience gave me absolute peace of mind during the birth of my second child. The clinic is spotlessly clean and feels just like home."
            </p>
          </div>
        </div>
      ...
      <div class="bg-white rounded-2xl p-8 border border-pink-200 hover:border-pink-400 hover:shadow-lg transition-all duration-300 flex flex-col justify-between">
        <div>
          ...
          <div class="border-l-2 border-pink-200 pl-4 mb-8">
            <p class="text-gray-600 font-montserrat leading-relaxed text-sm">
              "The Baby Spa was incredible! My baby sleeps so much better and eats with full appetite after her massage session. The midwife and team are exceptionally gentle."
            </p>
          </div>
        </div>
      ...
      <div class="bg-white rounded-2xl p-8 border border-pink-200 hover:border-pink-400 hover:shadow-lg transition-all duration-300 flex flex-col justify-between">
        <div>
          ...
          <div class="border-l-2 border-pink-200 pl-4 mb-8">
            <p class="text-gray-600 font-montserrat leading-relaxed text-sm">
              "Using BPJS, I received top-tier, highly professional treatment with zero discrimination. Midwife Deby truly prioritizes patient safety and well-being above all else."
            </p>
          </div>
        </div>
